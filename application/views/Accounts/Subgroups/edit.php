              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <select name="groups" id="groups" class="form-control" required>
                    ...
                    {
                      ?>
                      <option value="<?php echo $row->group_id ?>" <?php if(isset($records[0]->group_parent_id)) if ($records[0]->group_parent_id == $row->group_id)  echo "selected" ?>><?php echo $row->group_name; ?></option>
                      <?php
                    }
                    ?>
                  </select>
