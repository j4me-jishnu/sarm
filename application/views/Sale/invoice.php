            ...
            <input type="hidden" id="response" value="<?php echo $this->session->flashdata('response');?>" />
                <table class="table table-bordered" id="table_purchase" class="A5">
                    <tbody>
                        ...
                        <tr style="text-align: center;">
                            <td colspan="4"><b>Customer:</b> <?php echo $records[0]->custname ?></td>
                            
                            <td><b>SL No:</b> <?php echo @$records[0]->invoice_number ?></td>
                            <td><b>Date:</b> <?php echo $records[0]->sale_date ?></td>
                        </tr>
                        <tr style="text-align: center;">
                            <td><b>Sr No</b></td>
