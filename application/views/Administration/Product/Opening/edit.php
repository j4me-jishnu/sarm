        ...
        <div class="col-md-12">
          <div class="box">
            <fieldset>
              ...
              <input type="hidden" name="open_id" value="<?php if(isset($records->opening_id)) echo $records->opening_id ?>" >
              ...
              <?php } ?>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    ...
                    <input type="text" name="item_name" class="form-control" disabled value="<?php echo $records->product_name ?>">
                    <input type="hidden" name="item" value="<?php echo $records->item_id ?>" >
                  </div>
                </div>
