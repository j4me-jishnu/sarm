<script>
  ...
  $(function () {
    ...
    $table = $('#color_table').DataTable( {
        ...
        "ajax": {
            "url": "<?php echo base_url();?>index.php/color/get/",
            "type": "POST",
            "data" : function (d) {
        ...
        "createdRow": function ( row, data, index ) {
            ...
            $('td', row).eq(3).html('<center><a href="<?php echo base_url();?>index.php/color/edit/'+data['color_id']+'"><i class="fa fa-edit iconFontSize-medium" ></i></a> &nbsp;&nbsp;&nbsp;<a onclick="return confirmDelete('+data['color_id']+')"><i class="fa fa-trash-o iconFontSize-medium" ></i></a></center>');
        ...
        "columns": [
            { "data": "color_id", "orderable": true },
            { "data": "color_name", "orderable": false },
            { "data": "color_remarks", "orderable": false },
            //{ "data": "category_description", "orderable": false },
            { "data": "color_status", "orderable": false }
...
function confirmDelete(color_id){
    var conf = confirm("Do you want to Delete Color ?");
    if(conf){
        $.ajax({
            url:"<?php echo base_url();?>index.php/color/delete",
