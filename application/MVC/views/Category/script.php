  ...
  $(function () {
    ...
    $table = $('#category_table').DataTable( {
        ...
        "createdRow": function ( row, data, index ) {
            ...
            $('td', row).eq(3).html('<center><a href="<?php echo base_url();?>index.php/category/edit/'+data['category_id']+'"><i class="fa fa-edit iconFontSize-medium" ></i></a> &nbsp;&nbsp;&nbsp;<a onclick="return confirmDelete('+data['category_id']+')"><i class="fa fa-trash-o iconFontSize-medium" ></i></a></center>');
