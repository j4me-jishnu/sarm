          ...
          <div class="box box-info">
            ...
            <form class="form-horizontal" method="POST" action="<?php echo base_url();?>index.php/sale/add">
              <!-- radio -->
			   ...
			   <input type="text" name="cust_details" value="<?php if(isset($getcustid[0]->cust_details)) echo $getcustid[0]->cust_details ?>"/>
              ...
              <div class="form-group">
              <div class="col-md-6 pull-right" style="display: none" id="availbalance">
                ...
                <div class="box-body">
                  ...
                  <div class="callout callout-info">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <input type="text" placeholder="Date" class="form-control" data-pms-required="true" name="sale_date" id="date" value="<?php if(isset($records->sale_date)) { echo $records->sale_date;} else{ echo date('d/m/Y');} ?>">
                        </div>
