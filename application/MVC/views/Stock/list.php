    ...
    <section class="content">
      <div class="row">
        <div class="box">
            <div class="row">
                <div class="col-md-3">
                    <div class="input-group margin">
                        ...
                        <input type="text" name="product_name" placeholder="Product Name" id="productname" class="form-control">
                    </div><!-- /input-group -->
		</div>
                ...
                <div class="col-md-3">
                    <div class="input-group margin">
                        ...
                        <input type="text" name="subcategory_name" placeholder="Sub Category Name" id="subcategory_name" class="form-control">
                    </div><!-- /input-group -->
		</div>
                ...
                <div class="col-md-3">
                    <div class="input-group margin">
                        ...
                        <input type="text" name="size_name" placeholder="Size" id="size_name" class="form-control">
                    </div><!-- /input-group -->
		</div>
                ...
                <div class="col-md-3">
                    <div class="input-group margin">
                        ...
                        <input type="text" name="color_name" placeholder="Color" id="color_name" class="form-control">
                    </div><!-- /input-group -->
                </div>
			...
			<div class="col-sm-1">
				<div class="input-group">
					<a href="<?php echo base_url();?>index.php/stock"><button class="btn bg-navy btn-flat margin" >Refresh</button></a>
				</div>
			</div>
		  ...
		  <div class="btn-group">
            ...
            <div class="box-body table-responsive">
              <table id="stock_details_table" class="table table-bordered table-striped">
                <thead>
                <tr>
                  <th>Sl No.</th>
				  <th>Product Name</th>
