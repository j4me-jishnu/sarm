  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url();?>index.php/SaleReturn/add"><i class="fa fa-dashboard"></i> Back To Add</a></li>
        <li class="active">Sale Returns Details</li>
      </ol>
    </section>
    ...
    <section class="content">
        <div class="row">
            ...
            <div class="col-sm-1">
                    <div class="input-group">
                            <a href="<?php echo base_url();?>index.php/SaleReturn"><button class="btn bg-navy btn-flat margin" >Refresh</button></a>
                    </div>
            </div>
        </div>
      ...
      <div class="row">
        <div class="box">
            ...
            <input type="hidden" id="response" value="<?php echo $this->session->flashdata('response');?>" />
              ...
              <div class="col-md-10"><h2 class="box-title">Sale Returns Details</h2> </div>
		<div class="col-md-2">
                  <a href="<?php echo base_url();?>index.php/SaleReturn/add" class="btn btn-primary"><i class="fa fa-plus-square"></i> Add Returns</a>
		</div>
            </div>
            <!-- /.box-header -->
